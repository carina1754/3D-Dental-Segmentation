...
def load_segment_data(file_name): # file_name은 d_000.obj.. 이런 애들
    ...
    for line in seg_lines:
        ...
        if line_split[0] !=  'v':
            break
        name = line_split[0] + ' ' + line_split[1] + ' ' +line_split[2] + ' ' + line_split[3] + ' ' + line_split[4] + ' ' + line_split[5] + ' ' + line_split[6]
...
def new_searching(data):
    ...
    for line in par_lines:
        ...
        point = line_split[0] + ' ' + line_split[1] + ' ' +line_split[2] + ' ' + line_split[3] + ' ' + line_split[4] + ' ' + line_split[5] + ' ' + line_split[6]
