...
path = "C:\\Users\\buleb\\Desktop\\3D-Semantic-Segmentation\\datapred\\datapredict\\"
# rootpath = path + '\\datas\\segmentation-files(2)'
rootpath = 'blender2\\' ## output if saved in the root path
labelpath = rootpath + '\\labels'
fullpath = rootpath + '\\fullScans'
datapath = path + '\\blenderdata' ### this is the input data path
temppath = 'tmp/'
import time
start = time.time()
