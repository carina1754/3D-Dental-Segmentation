...
if __name__ == '__main__':
    ...
    train_list = './tensor_list/train_list_1_vtp_1000.csv' # use 1-fold as example
    val_list = './tensor_list/val_list_1_vtp_1000.csv' # use 1-fold as example
