...
if __name__ == '__main__':
    ...
    model_path = './models'
    model_name = 'Mesh_Segementation_MeshSegNet_15_classes_60samples.tar_best.tar'

    mesh_path = './'  # need to modify
    sample_filenames = ['AA_1994_M_0104_L.obj'] # need to modify
    output_path = './outputs'
    ...
    model = MeshSegNet_(num_classes=num_classes, num_channels=num_channels)
    ...
    with torch.no_grad():
        for i_sample in sample_filenames:
            ...
            vedo.write(mesh2, os.path.join(output_path, '{}_predicted_meshsnet_U.vtp'.format(i_sample[:-4])))
            ...
            vedo.write(mesh3, os.path.join(output_path, '{}_predicted_graphcut_meshsnet_U.vtp'.format(i_sample[:-4])))
            ...
            vedo.write(mesh, os.path.join(output_path, '{}_predicted_graphcut_upsampling_meshsnet_U.vtp'.format(i_sample[:-4])))
