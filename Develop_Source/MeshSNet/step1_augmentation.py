...
if __name__ == "__main__":
    ...
    num_samples = 820 # need to define # of samples; e.g., 30
    vtk_path = 'C:\\Users\\buleb\\Desktop\\3D-Semantic-Segmentation\\datapred\\datapredict\\rename_vtp_data(1)\\lower' # need to define the path; e.g., lower
    # vtk_path = 'result_vtp/upper' # need to define the path; e.g., upper
