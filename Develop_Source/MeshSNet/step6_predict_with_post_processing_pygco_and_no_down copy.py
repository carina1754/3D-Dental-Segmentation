...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for i_sample in sample_filenames:
            ...
            vedo.write(mesh2, os.path.join(output_path, '{}_predicted_meshsnet.vtp'.format(i_sample[:-4])))
            ...
            vedo.write(mesh3, os.path.join(output_path, '{}_predicted_graphcut_meshsnet.vtp'.format(i_sample[:-4])))
            ...
            vedo.write(mesh, os.path.join(output_path, '{}_predicted_graphcut_upsampling_meshsnet.vtp'.format(i_sample[:-4])))
