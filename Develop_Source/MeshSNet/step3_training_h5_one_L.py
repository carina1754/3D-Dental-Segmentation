...
if __name__ == '__main__':
    ...
    model_path = './models/'
    model_name = 'MeshSNet_L' # need to define
    checkpoint_name = 'latest_checkpoint_L.tar'
    ...
    Net = MeshSegNet_L(num_classes=num_classes, num_channels=num_channels, with_dropout=True, dropout_p=0.5).cuda()
